...
const deployedContracts = {
  31337: {
    ...
    Lending: {
      ...
      abi: [
        ...
        {
          inputs: [],
          name: "Lending_InsufficientBorrowed",
          type: "error",
        },
        {
          inputs: [],
          name: "Lending_InsufficientCollateral",
          type: "error",
        },
        {
          inputs: [],
          name: "Lending_InvalidAmount",
          type: "error",
        },
        {
          inputs: [],
          name: "Lending_UnsafePositionRatio",
          type: "error",
        },
        {
          inputs: [],
  ...
  11155111: {
    Corn: {
      address: "0x975a527837C91A25922339a4a0819d76772215Fa",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: 9326655,
    },
    CornDEX: {
      address: "0xB66Ee28E6413C333d72a2e73E4F6EBBdb0cf535A",
      abi: [
        {
          inputs: [
            {
    ...
    Lending: {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9326658,
    },
    MovePrice: {
      address: "0x7D3d800BF75B9467dcbf8AECC13A3e1714d52fF9",
      abi: [
        {
          inputs: [
            {
